...
<style>
    ...
    .bg-SLPA { background: #0369a1; } 
    .bg-MSS { background: #0f766e; }
    .bg-JCT { background: #7c2d12; }
...
<div class="dashboard-header">
    <h1><i class="fa-solid fa-ship"></i> MARITIME PROJECTS</h1>
    ...
    <div class="drawer-content">
        ...
        <div class="field-group">
            ...
            <select id="instFilter" class="select-input">
                ...
                <option value="SLPA" <?= $selectedOrg == 'SLPA' ? 'selected' : '' ?>>SLPA</option>
                <option value="MSS" <?= $selectedOrg == 'MSS' ? 'selected' : '' ?>>MSS</option>
            </select>
        </div>
